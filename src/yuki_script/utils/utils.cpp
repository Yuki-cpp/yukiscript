...
{
	static auto ctrl_check = [](unsigned char x)
	{
	...
	std::string::iterator new_end = std::remove_if(code.begin(), code.end(), ctrl_check);
...
namespace
{
void print_tree_impl(const std::string & code, std::ostream & os, std::size_t level)
{
